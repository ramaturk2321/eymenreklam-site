...
export const socialLinks: SocialLink[] = [
  {
    name: 'Instagram',
    url: 'https://www.instagram.com/eymenreklam/',
...
export const company = {
  ...
  founded: 1999,
  experience: new Date().getFullYear() - 1999,
