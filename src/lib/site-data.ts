// ============================================================
// Eymen Reklam — Merkezi Site Verileri
// Tüm site bu dosyadan okur. Değişiklik burada yapılır.
// ============================================================
...
export const contact = {
  ...
  email: 'info@eymenreklam.com',
  emailHref: 'mailto:info@eymenreklam.com',
...
export interface SocialLink {
  ...
  color: string; // hover renk
}

export const socialLinks: SocialLink[] = [
  {
    name: 'Instagram',
    url: 'https://www.instagram.com/eymenreklamltd/',
